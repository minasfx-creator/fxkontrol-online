...
const CONTROLLERS: ControllerCard[] = [
  ...
  { id: 'maiman', name: 'Maiman 30W', manufacturer: 'Showven', type: 'laser', connectionTypes: ['artnet'], channels: 16, description: '30W RGB laser · FB3 16CH · ILDA + DMX · IP65', group: 'showven' },
  { id: 'cflamer-mvolcano', name: 'cFlamer mVolcano', manufacturer: 'Showven', type: 'sfx', connectionTypes: ['usb', 'artnet'], channels: 6, description: '5-nozzle color flame · 6CH DMX · 88 presets · E-Stop', panelMode: 'zk6200', group: 'showven' },
  { id: 'dmx-splitter8', name: 'DMX Splitter 8', manufacturer: 'Showven', type: 'dmx', connectionTypes: ['usb'], channels: 8, description: '1→8 DMX512 splitter · Opto-isolated · E-Stop chain', group: 'infrastructure' },
  ...
  { id: 'pyro-adaptor', name: 'PyroAdaptor', manufacturer: 'Showven', type: 'module', connectionTypes: ['pbus', 'wireless'], channels: 25, description: 'PBUS charger · 25x C16 units · dual-band RF relay', panelMode: 'pbus', group: 'showven' },
