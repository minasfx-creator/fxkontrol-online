                    ...
                    <TooltipContent side="top" className="text-[10px] font-mono">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <span className="text-muted-foreground">
                          {formatCueTime(item.startTime)} · {effect.duration}s
                          {effect.caliber && ` · ${effect.caliber}"`}
                          {effect.heightMeters && ` · ${effect.heightMeters}m`}
                        </span>
                        {effect.pattern && (
                          <span className="text-muted-foreground">Pattern: {effect.pattern}</span>
                        )}
                      </div>
                    </TooltipContent>
                  </Tooltip>
