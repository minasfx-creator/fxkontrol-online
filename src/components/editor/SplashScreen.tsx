...
export default function SplashScreen({ onStart }: SplashScreenProps) {
  ...
  const handleStart = () => {
    setPhase('exit');
    setTimeout(() => onStart(fleetSize), 600);
  };
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <h1
            className="text-3xl font-bold tracking-[0.2em] uppercase text-foreground"
        ...
        <Button
          onClick={handleStart}
          className="px-8 py-3 h-auto text-sm font-semibold tracking-[0.15em] uppercase bg-gradient-to-r from-electric to-electric-glow hover:shadow-[0_0_24px_hsl(var(--electric)/0.4)] transition-all duration-300"
        >
          Start Workstation
        </Button>
