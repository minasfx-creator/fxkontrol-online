...
export function PerformanceHUD({
  ...
  return (
    <>
      <button
        onClick={toggle}
        className="absolute top-3 right-16 z-20 glass-hud-md text-muted-foreground hover:text-foreground px-2 py-1 transition-all"
      ...
      {visible && (
        <div className="absolute top-10 right-16 z-20 glass-hud-md p-2 font-mono text-[10px] leading-relaxed min-w-[140px] select-none pointer-events-none">
