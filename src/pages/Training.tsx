    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-4 gap-2 animate-fxk-fade-up" style={{ animationDelay: '0.1s' }}>
        {[
          ...
          { icon: Users, label: 'Rank', value: totalXP >= 500 ? 'Técnico' : 'Novato', color: 'text-[hsl(var(--fxk-violet))]' },
        ].map(stat => (
      ...
      {chapters.map((chapter, ci) => (
        <div key={chapter} className="space-y-2 animate-fxk-fade-up" style={{ animationDelay: `${0.2 + ci * 0.05}s` }}>
          <h2 className="text-[10px] font-mono font-bold text-muted-foreground uppercase tracking-[0.15em] px-1">{chapter}</h2>
