...
export const BUILTIN_TEMPLATES: Omit<ShowTemplate, 'id' | 'createdAt'>[] = [
  ...
  // ── Venue templates (ZIP archives, 2026-05-24) ────────────────────────
  {
    name: 'Estadio Azteca — Championship',
    description: '10 launch positions on the 50m stadium ring + 2 center field. 8-minute sports celebration show at 2,240m altitude in Mexico City.',
    category: 'sports',
    duration: 480,
    droneCount: 0,
    formationCount: 0,
    formations: [],
    tags: ['azteca', 'mexico', 'stadium', 'championship', 'copa', 'sports'],
  },
  {
    name: 'Taj Mahal — Diwali Celebration',
    description: 'UNESCO heritage Diwali show: 8 garden positions along Charbagh canal + 4 minaret heights. Reflective pool doubles visual impact.',
    category: 'holiday',
    duration: 600,
    droneCount: 0,
    formationCount: 0,
    formations: [],
    tags: ['taj-mahal', 'india', 'diwali', 'heritage', 'mughal', 'garden'],
  },
  {
    name: 'Busan Gwangan Bridge — Korean NYE',
    description: '20 positions along 7.4km Diamond Bridge + 8 barges at Gwangalli Beach. K-pop precision timing for 1M+ beachfront audience.',
    category: 'countdown',
    duration: 600,
    droneCount: 0,
    formationCount: 0,
    formations: [],
    tags: ['busan', 'korea', 'gwangan', 'bridge', 'nye', 'kpop'],
  },
  {
    name: 'Sydney 2018 Countdown (Authentic VSC)',
    description: 'Real show design from VSDCreator: 29 authentic bridge positions, StrobePot red sweep, and "2018" digit display at P1/P10/P20/P29.',
    category: 'countdown',
    duration: 130,
    droneCount: 0,
    formationCount: 0,
    formations: [],
    tags: ['sydney', 'bridge', 'countdown', 'authentic', 'vsc', 'vsdcreator', '2018'],
  },
];
