...
const VDL_TYPES: Record<string, VDLTypeSpec> = {
  ...
  // ── Aerial Burst Patterns (baseStars/baseBreakSpeed at 3" = Finale reference) ──
  peony:         { name: 'Peony', baseSpread: 45, baseDuration: 1.6, baseStars: 150, baseBreakSpeed: 28, trailDefault: 'none', partType: 'shell' },
  chrysanthemum: { name: 'Chrysanthemum', baseSpread: 52, baseDuration: 2.2, baseStars: 200, baseBreakSpeed: 30, trailDefault: 'comet', partType: 'shell' },
  dahlia:        { name: 'Dahlia', baseSpread: 38, baseDuration: 1.2, baseStars: 80,  baseBreakSpeed: 35, trailDefault: 'none', partType: 'shell' },
  willow:        { name: 'Willow', baseSpread: 55, baseDuration: 4.0, baseStars: 180, baseBreakSpeed: 20, trailDefault: 'charcoal', partType: 'shell' },
  palm:          { name: 'Palm', baseSpread: 60, baseDuration: 3.5, baseStars: 60,  baseBreakSpeed: 24, trailDefault: 'comet', partType: 'shell' },
  coconut:       { name: 'Coconut Palm', baseSpread: 65, baseDuration: 4.5, baseStars: 40,  baseBreakSpeed: 22, trailDefault: 'comet', partType: 'shell' },
  brocade:       { name: 'Brocade Crown', baseSpread: 50, baseDuration: 3.2, baseStars: 250, baseBreakSpeed: 25, trailDefault: 'brocade', partType: 'shell' },
  kamuro:        { name: 'Kamuro', baseSpread: 55, baseDuration: 5.0, baseStars: 300, baseBreakSpeed: 18, trailDefault: 'glitter', partType: 'shell' },
  horsetail:     { name: 'Horsetail', baseSpread: 30, baseDuration: 4.5, baseStars: 100, baseBreakSpeed: 18, trailDefault: 'charcoal', partType: 'shell' },
  crossette:     { name: 'Crossette', baseSpread: 35, baseDuration: 2.0, baseStars: 36,  baseBreakSpeed: 32, trailDefault: 'comet', partType: 'shell' },
