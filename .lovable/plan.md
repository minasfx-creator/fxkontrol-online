...
- 🟢 **Fase 1 fechada no software**: golden seed → VerificationEngine.READY_FOR_EXPORT + Show3DEngine consome o plano + bundles honestos exportáveis. Pronto para Fase 2 (hardware físico em mesa).
