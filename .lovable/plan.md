...
- ⏳ Próximo: validar critério de saída — `pendingRequiredAdapters()` zerado em sessão real com FXK16 conectado; preparar Fase 1 (Show Libertadores como golden show).
